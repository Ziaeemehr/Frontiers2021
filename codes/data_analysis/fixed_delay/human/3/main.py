...
if __name__ == "__main__":
    ...
    ax = make_grid(nrows=1, ncols=5, left=0.05, right=0.96,
                   bottom=0.55, top=0.93,
    ...
    for i in range(len(nu)):
        ...
        plot_scatter(y, z, c=x, ax=ax[i], alpha=0.5,
    ...
    ax1[0].text(-0.07, 0.7, labels[1], fontsize=18,
                transform=ax1[0].transAxes)
    ax1[1].text(-0.12, 0.7, labels[2], fontsize=18,
